        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Logo = table.Column<byte[]>(type: "varbinary(max)", maxLength: 512000, nullable: true),
                    Description = table.Column<string>(type: "nvarchar(3000)", maxLength: 3000, nullable: true),
                    UniqueReferenceNumber = table.Column<string>(type: "nvarchar(13)", maxLength: 13, nullable: true),
                    ChiefFirstName = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    ChiefLastName = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Routes_Airports_EndAirportId",
                        column: x => x.EndAirportId,
                        principalTable: "Airports",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Routes_Airports_StartAirportId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Routes_EndAirportId",
                table: "Routes",
                column: "EndAirportId");

            migrationBuilder.CreateIndex(
                name: "IX_Routes_StartAirportId",
                table: "Routes",
